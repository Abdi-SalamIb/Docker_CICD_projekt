...
namespace PersonnummerKontrollApp
{
    ...
    public static class PersonnummerValidator
    {
        public static ValidationResult Validate(string input)
        {
            ...
            if (digits.Length == 12)
            {
                ...
                if (!DateTime.TryParseExact(yyyyMMdd, "yyyyMMdd", CultureInfo.InvariantCulture, DateTimeStyles.None, out birthDate))
            ...
            else
            {
                ...
                if (!DateTime.TryParseExact(yyMMdd, "yyMMdd", CultureInfo.InvariantCulture, DateTimeStyles.None, out var parsed))
        ...
        {
            if (last10Digits.Length != 10 || !last10Digits.All(char.IsDigit)) return false;
    ...
    public sealed class ValidationResult
    {
        ...
        internal ValidationResult(bool isValid, string normalized, DateTime birthDate, string genderHint, string errorMessage)
        {
            IsValid = isValid;
